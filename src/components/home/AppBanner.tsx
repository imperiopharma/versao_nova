...
export const AppBanner: React.FC = () => {
  return (
    <section className="py-6 bg-imperio-navy text-white">
      <div className="section-container">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0 md:mr-8 text-center md:text-left">
            <h2 className="text-xl font-display font-bold mb-2">Império Pharma no seu bolso</h2>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              <img 
                ...
                alt="App Store" 
                className="h-9 cursor-pointer hover-lift"
              />
              <img 
