        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-100 shadow-subtle">
            <img 
              src={product?.image} 
              alt={product?.name} 
              className="w-full h-auto max-h-80 md:max-h-96 object-contain mx-auto"
            />
          </div>
          ...
          <div className="space-y-4">
            <div>
              <h1 className="text-xl md:text-2xl font-semibold text-imperio-navy">{product?.name}</h1>
              <p className="text-gray-600 mt-1">Marca: {product?.brand}</p>
              <p className="text-sm text-gray-500 mt-1">SKU: {product?.sku}</p>
              {product?.isCombo && (
                <div className="mt-2">
                  <span className="inline-block px-2 py-1 bg-imperio-extra-light-navy text-imperio-navy text-xs font-semibold rounded-full">
                    Combo
                  </span>
                </div>
              )}
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm md:text-base">{product?.description || "Sem descrição disponível."}</p>
            </div>
